...
import { GetPropertyByIdService } from './get-property-by-id.service';
import { PropertyRepository } from '../../repositories/property.repository';
import { NotFoundException } from '@nestjs/common';

describe('GetPropertyByIdService', () => {
  let service: GetPropertyByIdService;
  ...
  beforeEach(async () => {
    ...
    service = module.get<GetPropertyByIdService>(GetPropertyByIdService);
